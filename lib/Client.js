...
Client.prototype.addFriend = function(friendid) {
    if (!_(this.friendids).contains(friendid)) this.friendids.push(friendid);
}

Client.prototype.removeFriend = function(friendid) {
    var i = this.friendids.indexOf(friendid);
    if (i >= 0) this.friendids.splice(i, 1);
}
